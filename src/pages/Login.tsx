...
import { Ship, User, LogIn } from "lucide-react";
      ...
      <div className="container mx-auto px-4 py-12 md:py-16 flex flex-col items-center">
        <div className="w-full max-w-md space-y-6">
          <div className="text-center">
            ...
            <h1 className="mt-4 text-3xl font-bold">Masuk ke Akun Anda</h1>
            <p className="mt-2 text-gray-600">
              Akses fitur pelacakan kapal dan berbelanja sayuran segar
            </p>
          </div>
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="flex justify-between items-center text-sm">
                <div className="flex items-center space-x-2">
                  <input type="checkbox" id="remember" className="rounded text-sayur-green focus:ring-sayur-green" />
          ...
          <div className="text-center">
            <p className="text-sm text-gray-600">
              Belum memiliki akun?{" "}
              <Link to="/daftar" className="text-sayur-blue hover:underline font-medium">
                Daftar sekarang
              </Link>
            </p>
          </div>
